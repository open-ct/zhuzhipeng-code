...
See also the standalone Python package 
[opensmile-python](https://github.com/audeering/opensmile-python) for an easy-to-use wrapper 
...
openSMILE, see the [usage instructions](https://opensmile.readthedocs.io/en/latest/usage.html)
