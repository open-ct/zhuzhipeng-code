...
class DNN_Model(Common_Model):
    ...
    def train(self, x_train, y_train, x_val = None, y_val = None, 
        ...
        history = self.model.fit(
            ...
            epochs = n_epochs,
            shuffle = True,class_weight='auto', # 每个 epoch 开始前随机排列训练数据
        ...
        plotCurve(acc, val_acc,f'{config.dataset_name}_acc', 'Accuracy')
        plotCurve(loss, val_loss,f'{config.dataset_name}_loss', 'Loss')
